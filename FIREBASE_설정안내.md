...
- `mapFeatures`: 관리자가 추가·수정·삭제한 4종 안전시설의 선과 위치
- `mapFeatureHistory`: 안전시설 수정 이력

시민참여단 앱은 의견 등록만 가능하고, 기존 의견을 읽거나 수정할 수 없습니다. 안전시설은 누구나 읽을 수 있지만 관리자만 변경할 수 있습니다. 관리자만 로그인 후 전체 의견을 읽고 내용·위치·처리상태를 수정하거나 삭제·복구하고, 4종 안전시설을 변경할 수 있습니다.
