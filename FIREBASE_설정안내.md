...
- `mapFeatures`: 관리자가 추가·수정·삭제한 안심귀갓길과 안전골목 선
- `mapFeatureHistory`: 안전시설 선 수정 이력

시민참여단 앱은 의견 등록만 가능하고, 기존 의견을 읽거나 수정할 수 없습니다. 안전시설 선은 누구나 읽을 수 있지만 관리자만 변경할 수 있습니다. 관리자만 로그인 후 전체 의견을 읽고 처리상태와 안전시설 선을 변경할 수 있습니다.
